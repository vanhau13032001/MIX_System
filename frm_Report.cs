    ...
    public partial class frm_Report : Form
    {
        ...
        private void frm_Report_Load(object sender, EventArgs e)
        {
            ...
            if (rpSearchBy.ToString() == "True")
            {
                ...
                this.Mix_System_DataTableAdapter.Fill
                    (this.DssqlReport.Mix_System_Data, DateStart, DateEnd);
                // Làm mới báo cáo
            ...
            else
            {
                ...
                {
                    // Đưa câu lệnh query sang Dataset
                    this.Mix_System_DataTableAdapter.FillBy
                        (this.DssqlReport.Mix_System_Data, Search_Start,
                ...
                else // Ca A và ca B
                {
                    // Đưa câu lệnh query sang Dataset
                    this.Mix_System_DataTableAdapter.FillBy
                        (this.DssqlReport.Mix_System_Data,
